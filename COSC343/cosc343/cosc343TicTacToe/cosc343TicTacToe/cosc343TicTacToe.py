...
def possible_actions_from_state(state):
   ...
   :return: a list of tuples of moves possible from state
   """
...
def transition(state, a, player):
   """
   Returns a new state resulting from the current state and the action
   :param state: a list of rows (each a list of columns) of tictactoe board
   :param a: a tuple (r,c) representing the move to be made
   :param player: 1 for max, -1 for min
   :return: a new state resulting from the current state and the action
   """
